...
childrenLeft = np.fromfile("dt/childLeft.bin", dtype=int)
childrenRight = np.fromfile("dt/childrenRight.bin", dtype=int)
feature = np.fromfile("dt/feature.bin", dtype=int)
threshold = np.fromfile("dt/threshold.bin", dtype=int)
value = np.fromfile("dt/value.bin", dtype=int)
...
with open('xdp_dt.c', 'r', encoding='utf-8') as f:
    program = f.read()
# print("device:")
# device = input()
device = "enp5s0"
