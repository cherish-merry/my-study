...
if __name__ == '__main__':
    ...
    clf.tree_.children_left.tofile("../xdp/feature/dt/childLeft.bin")
    clf.tree_.children_right.tofile("../xdp/feature/dt/childrenRight.bin")
    clf.tree_.feature.tofile("../xdp/feature/dt/feature.bin")
    clf.tree_.threshold.astype(int).tofile("../xdp/feature/dt/threshold.bin")
    (clf.tree_.impurity*100).astype(int).tofile("../xdp/feature/dt/impurity.bin")
    value = []
    values = clf.tree_.value
    for val in values:
        value.append(np.argmax(val))
    np.array(value).tofile("../xdp/feature/dt/value.bin")
    ...
    graph.render("../xdp/feature/dt/decide_tree")
